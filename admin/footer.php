...
<?php /*?>
    ...
    <script src="<?=$my_root.'admin/asset';?>/vendor/raphael/raphael.min.js"></script>
    <script src="<?=$my_root.'admin/asset';?>/vendor/morrisjs/morris.min.js"></script>
    <script src="<?=$my_root.'admin/asset';?>/data/morris-data.js"></script>
<?php */ ?>

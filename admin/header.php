            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?=$my_root.'admin/logout.php';?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=$my_root.'admin/blog.php';?>">Blog List</a>
                                </li>
                                <li>
                                    <a href="<?=$my_root.'admin/addnew.php';?>">Add New Post</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=$my_root.'admin/profile.php';?>">Update Profile</a>
                                </li>
                                <li>
                                    <a href="<?=$my_root.'admin/knowledge.php';?>">Knowledge</a>
                                </li>
                                <li>
                                    <a href="<?=$my_root.'admin/myskill.php';?>">My Skill</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="<?=$my_root.'admin/references.php';?>"><i class="fa fa-files-o fa-fw"></i>References</a>
                        </li>
                        <li>
